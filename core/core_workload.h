...
namespace ycsbc {
    ...
    public:
        ...
        static const std::string TOTAL_SLOTS_PROPERTY;
        static const std::string TOTAL_SLOTS_DEFAULT;

        ///
        /// Whether we use hash_prefix, 0 for not use, 1 for use
        ///

        static const std::string KEY_RANGE_NO_PROPERTY;
        static const std::string KEY_RANGE_NO_DEFAULT;

        static const std::string KEY_RANGE_DIST_A_PROPERTY;
        static const std::string KEY_RANGE_DIST_A_DEFAULT;


        static const std::string KEY_RANGE_DIST_B_PROPERTY;
        static const std::string KEY_RANGE_DIST_B_DEFAULT;


        static const std::string KEY_RANGE_DIST_C_PROPERTY;
        static const std::string KEY_RANGE_DIST_C_DEFAULT;


        static const std::string KEY_RANGE_DIST_D_PROPERTY;
        static const std::string KEY_RANGE_DIST_D_DEFAULT;


        ///
        /// hotness of different key ranges
        ///

        static const std::string KEY_RANGE_HOTNESS_ARRAY_PROPERTY;
        static const std::string KEY_RANGE_HOTNESS_ARRAY_DEFAULT;
        ...
        /// The default zero padding value. Matches integer sort order
        ///
        static const std::string KEY_LEN_PROPERTY;
        static const std::string KEY_LEN_DEFAULT;
        ...
        CoreWorkload() :
                ...
                field_len_generator_(nullptr), key_chooser_(nullptr),
                field_chooser_(nullptr),
                scan_len_chooser_(nullptr), insert_key_sequence_(nullptr),
                transaction_insert_key_sequence_(nullptr), ordered_inserts_(true),
                record_count_(0) {
        }
...
//            fflush(key_range_result);
//            fclose(key_range_result);
        }
    ...
    protected:
        ...
        void BuildValues(std::unordered_map<std::string, std::string> &values);

        void BuildSingleValue(std::unordered_map<std::string, std::string> &update);
...
//        FILE *key_range_result;
    ...
    inline std::string CoreWorkload::NextFieldName() {
        return std::string(field_prefix_).append(
